...
OPMaps* OPMaps::m_pInstance = nullptr;
    ...
    if(ret.isEmpty()) {
        ...
        if(accessmode != AccessMode::CacheOnly) {
            ...
            case MapType::GoogleHybrid: {
                qheader.setRawHeader("Referer", "https://maps.google.com/");
            }
            break;
            ...
            case MapType::GoogleHybridChina: {
                qheader.setRawHeader("Referer", "http://ditu.google.cn/");
            }
            break;
            ...
            case MapType::BingSatellite: {
                qheader.setRawHeader("Referer", "http://www.bing.com/maps/");
            }
            break;
            ...
            case MapType::YahooSatellite: {
                qheader.setRawHeader("Referer", "http://maps.yahoo.com/");
            }
            break;
            ...
            case MapType::ArcGIS_MapsLT_Map_Hybrid: {
                qheader.setRawHeader("Referer", "http://www.maps.lt/map_beta/");
            }
            break;

            case MapType::OpenStreetMapSurfer:
            case MapType::OpenStreetMapSurferTerrain: {
                qheader.setRawHeader("Referer", "http://www.mapsurfer.net/");
            }
            break;

            case MapType::OpenStreetMap:
            case MapType::OpenStreetOsm: {
                qheader.setRawHeader("Referer", "http://www.openstreetmap.org/");
            }
            break;

            case MapType::YandexMapRu: {
                qheader.setRawHeader("Referer", "http://maps.yandex.ru/");
            }
            break;
            case MapType::Statkart_Topo2: {
                qheader.setRawHeader("Referer", "http://www.norgeskart.no/");
            }
            break;
            case MapType::AMap_Normal:
            case MapType::AMap_Hybrid:
            case MapType::AMap_Satellite: {
                qheader.setRawHeader("Referer", "https://www.amap.com/");
                qheader.setRawHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36");
            }
            break;
            default:
                break;
